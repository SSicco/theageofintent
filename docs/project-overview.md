...
- Runs on Haiku before each conversation turn.
- Summarises prior exchanges that need summarising and assembles the full prompt for the conversation agent.
- This agent is invisible to the reader — it operates entirely behind the scenes.
